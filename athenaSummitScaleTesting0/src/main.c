...
/* Do userwork before the main loop */
  printf("%s \n", "MARKER before Userwork_before_loop");
  //Userwork_before_loop(&Mesh);
  printf("%s \n", "MARKER after Userwork_before_loop");
...
/*--- Step 9h part 2 NEW THING I ADDED. ---------------------------------------------------------------*/
/* User work 2 (defined in problem()) */

    //Userwork_in_loop2(&Mesh);
