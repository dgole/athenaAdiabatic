 ...
 */
      ...
      if (CoolingFunc != NULL){
        for (i=il+1; i<=iu; i++) {
          coolfl = (*CoolingFunc)(Wl[i].d,Wl[i].P,(0.5*pG->dt), pG, i, j, k);
          coolfr = (*CoolingFunc)(Wr[i].d,Wr[i].P,(0.5*pG->dt), pG, i, j, k);
 ...
 */
      ...
      if (CoolingFunc != NULL){
        for (j=jl+1; j<=ju; j++) {
          coolfl = (*CoolingFunc)(Wl[j].d,Wl[j].P,(0.5*pG->dt), pG, i, j, k);
          coolfr = (*CoolingFunc)(Wr[j].d,Wr[j].P,(0.5*pG->dt), pG, i, j, k);
 ...
 */
      ...
      if (CoolingFunc != NULL){
        for (k=kl+1; k<=ku; k++) {
          coolfl = (*CoolingFunc)(Wl[k].d,Wl[k].P,(0.5*pG->dt), pG, i, j, k);
          coolfr = (*CoolingFunc)(Wr[k].d,Wr[k].P,(0.5*pG->dt), pG, i, j, k);
 ...
 */
  ...
  if (CoolingFunc != NULL){
    for (k=ks; k<=ke; k++){
      for (j=js; j<=je; j++){
        for (i=is; i<=ie; i++){
          coolf = (*CoolingFunc)(dhalf[k][j][i],phalf[k][j][i],pG->dt, pG, i, j, k);
